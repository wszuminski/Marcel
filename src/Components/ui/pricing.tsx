...
const pricingPlans = [
  {
    ...
    subtitle: "Indywidualny plan treningowy",
    price: 300,
    showPrice: true,
    description:
      "Otrzymujesz prosty i skuteczny plan dopasowany do Twojego celu i dostępnego sprzętu.",
    gradient: "from-indigo-600/20 to-purple-600/20",
    borderGradient: "from-indigo-400 to-purple-400",
    features: [
      "Krótka konsultacja i ankieta startowa",
      "Plan treningowy",
      "Dopasowanie do sprzętu i czasu ćwiczeń",
      "Serie, powtórzenia, tempo i wskazówki techniczne",
      "Jedna aktualizacja planu po 6 tygodniach",
      "Podsumowanie i zalecenia na dalszy okres",
    ],
    highlight: true,
    badge: null,
  },
  {
    ...
    subtitle: "Pełna opieka i kontakt",
    price: null,
    showPrice: false,
    priceText: "Wycena indywidualna",
    description:
      "Stała współpraca: plan, dieta, kontrola postępów i wsparcie 1-na-1.",
    gradient: "from-indigo-500/20 to-purple-500/20",
    borderGradient: "from-rose-400 to-pink-400",
    features: [
      "Plan treningowy i plan żywieniowy na bieżąco",
      "Cotygodniowa kontrola i feedback",
      "Modyfikacje pod wyniki i samopoczucie",
      "Kontakt przez WhatsApp (w ustalonych godzinach)",
      "Analiza wideo techniki ćwiczeń",
      "Monitorowanie progresu i proste wskazówki regeneracji",
    ],
    highlight: false,
    badge: null,
  },
      ...
      >
        ...
        <motion.div className="text-center mb-16 sm:mb-20" variants={fadeInUp}>
          ...
          >
            ...
            dopasowany do Twoich celów i możliwości.
          </motion.p>
        </motion.div>
              ...
              >
                ...
                <div className="relative z-10 flex flex-col h-full">
                      ...
                      {plan.showPrice ? (
                        <>
                          ...
                          <span className="text-white/60">
                            {/* jednorazowo dla planu treningowego */}
                            {plan.name === "Plan treningowy"
                              ? "/jednorazowo"
                              : "/miesiąc"}
                          </span>
                        </>
                  ...
                  <motion.button
                    ...
                    aria-label={
                      plan.showPrice
                        ? `Wybierz plan ${plan.name} - ${plan.price} zł ${
                            plan.name === "Plan treningowy"
                              ? "jednorazowo"
                              : "miesięcznie"
                          }`
